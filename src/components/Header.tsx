  ...
  return (
    <header className="bg-[#203347] text-white px-4 md:px-10 py-3 flex items-center justify-between">
      ...
      <nav className="hidden md:flex space-x-6 text-sm font-medium">
        <Link to="/somniaFun" className="hover:text-blue-400">
          Somnia Pump
        </Link>
        <Link to="/swap" className="hover:text-blue-400">
          Swap
        </Link>
        <Link to="/ranking" className="hover:text-blue-400">
          Ranking
        </Link>
        <Link to="/createtoken" className="hover:text-blue-400">
          Create Token
        </Link>
      </nav>
      ...
      <div className="hidden md:flex items-center space-x-3">
        <Link
          to="/how-it-works"
          className="bg-transparent border border-blue-400 text-blue-400 px-3 py-1 rounded-md hover:bg-blue-400 hover:text-white transition"
        >
          How it works
        </Link>
